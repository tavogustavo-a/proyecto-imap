...
def ensure_whatsapp_web_columns():
    ...
    try:
        ...
        additions = [
            ...
            ('last_health_at', "ALTER TABLE whatsapp_configs ADD COLUMN last_health_at DATETIME"),
            ('last_health_error', "ALTER TABLE whatsapp_configs ADD COLUMN last_health_error TEXT"),
            ('last_disconnect_alert_at', "ALTER TABLE whatsapp_configs ADD COLUMN last_disconnect_alert_at DATETIME"),
            ...
            ('last_notify_at', 'ALTER TABLE whatsapp_configs ADD COLUMN last_notify_at DATETIME'),
            ('notify_run_log_json', 'ALTER TABLE whatsapp_configs ADD COLUMN notify_run_log_json TEXT'),
            ('notify_catchup_after', 'ALTER TABLE whatsapp_configs ADD COLUMN notify_catchup_after DATETIME'),
            (
                'last_notify_fail_alert_at',
                'ALTER TABLE whatsapp_configs ADD COLUMN last_notify_fail_alert_at DATETIME',
            ),
        ]
