...
def register_cli_commands(app):
    ...
    def create_admin_command():
        ...
        if not admin_username or not admin_pass:
            print("Error: ADMIN_USER y ADMIN_PASS deben estar definidos.")
            return
    ...
    def init_imap_keys_command():
        ...
        with app.app_context():
            ...
            if changed:
                db.session.commit()
                print("Claves IMAP inicializadas.")
            else:
                print("Las claves IMAP ya existían.")
            ...
            try:
                ...
                if not service:
                    ...
                    if alt:
                        ...
                        service = ServiceModel(name="Pais Netflix", color="black", border_color="#cc0000",
                ...
                db.session.commit()
                print("Seed Netflix completado.")
            except Exception as e:
                db.session.rollback()
                print(f"Error en seed Netflix: {e}")
