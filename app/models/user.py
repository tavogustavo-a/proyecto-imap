...
class User(db.Model):
    ...
    def to_dict(self):
        ...
        return {
            ...
            # ¡IMPORTANTE! NO exportar la contraseña hasheada directamente.
            # Si la importación necesita crear usuarios, genera una contraseña temporal
            # o requiere que el admin establezca una nueva. Por ahora, la omitimos.
