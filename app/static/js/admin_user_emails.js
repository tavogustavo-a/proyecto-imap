    ...
    if (popup) {
      document.addEventListener('mousedown', function(e) {
        if (popup.classList.contains('popup-show') || popup.classList.contains('popup-visible')) {
          if (!popup.contains(e.target) && !e.target.closest('.open-alias-popup') && !e.target.closest('#uniqueAllowedEmailsInfoBtn') && !e.target.closest('#regexFiltersAccessInfoBtn') && !e.target.closest('#subusersPermInfoBtn') && !e.target.closest('#subusersSectionInfoBtn')) {
            popup.classList.remove('popup-show', 'popup-visible');
            popup.classList.add('popup-hide');
            if (popupId === 'uniqueAllowedEmailsInfoModal' || popupId === 'regexFiltersAccessInfoModal' || popupId === 'subusersPermInfoModal' || popupId === 'subusersSectionInfoModal') {
