document.addEventListener("DOMContentLoaded", function() {
            ...
            <div style="background:${bg}; padding:6px;">
              <label style="display:flex; gap:0.5rem; align-items:center;">
                <input
                  ...
                  ${rx.allowed ? "checked" : ""}
                >
                <strong>${escapeHtml(rx.pattern)}</strong>
  ...
  if(saveCanCreateSubusersBtn && toggleCanCreateSubusers){
    saveCanCreateSubusersBtn.addEventListener("click", ()=>{
      ...
      const currentColor = mainContainer.dataset.color;       // Necesita data-color
      ...
      if (currentUsername === undefined || currentColor === undefined || currentPosition === undefined || currentCanSearchAny === undefined) {
